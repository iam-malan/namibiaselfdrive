  ...
  return (
    <main className="relative min-h-screen">
      ...
      >
        ...
        {/* About Section */}
        <section data-scroll-section className="py-24" id="about">
        ...
        <div data-scroll-section id="vehicles">
          <ModelsGrid />
        </div>
        ...
        {/* Tours Section */}
        <section data-scroll-section className="py-24" id="tours">
          <div className="content-wrapper">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              {tours.map((tour, index) => (
                ...
                >
                  <div className="feature-card h-full">
                    ...
                    <div className="mt-8">
                      <a href={`#tour-${index}`} className="btn btn-outline group inline-flex">
        ...
        <div data-scroll-section id="testimonials">
          <Testimonials />
        </div>

        {/* Contact Section */}
        <section data-scroll-section className="py-24" id="contact">
          <div className="content-wrapper">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
